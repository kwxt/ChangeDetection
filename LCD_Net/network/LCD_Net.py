...
class LCD_Net(nn.Module):
    ...
    def forward(self,A,B):
        ...
        print('layera',layer4_A.shape)#1,320,16,16
        ...
        print(' layer_As1, layer_As1', layer_As1.shape, layer_Bs1.shape)
        layer_ss=self.ffm(layer_As1,layer_Bs1)
        print('ss',layer_ss.shape)
        ...
        print('layer1_1:',layer1_1.shape)#(1,128,128,128)
        ...
        print('layer4_1,layer4_1,layer4_1,layer4_1', layer4_1.shape, layer3_1.shape, layer2_1.shape, layer1_1.shape)
...
if __name__ == '__main__':
   ...
   # mmengine_flop_count(model, (3, 512, 512), show_table=True, show_arch=True)
    ...
    print("flops=G", flops1 )#17811111936.0
    print("parms=M", params1 )#2560282.0